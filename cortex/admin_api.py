...
def list_avatar_skins(db: sqlite3.Connection = Depends(_db)):
...
def create_avatar_skin(skin: AvatarSkinCreate, db: sqlite3.Connection = Depends(_db)):
...
def get_avatar_skin(skin_id: str, db: sqlite3.Connection = Depends(_db)):
...
def delete_avatar_skin(skin_id: str, db: sqlite3.Connection = Depends(_db)):
...
def get_default_avatar_skin(db: sqlite3.Connection = Depends(_db)):
...
def set_default_avatar_skin(skin_id: str, db: sqlite3.Connection = Depends(_db)):
...
def list_avatar_assignments(db: sqlite3.Connection = Depends(_db)):
...
def assign_avatar_skin(user_id: str, body: AvatarAssignment, db: sqlite3.Connection = Depends(_db)):
...
def remove_avatar_assignment(user_id: str, db: sqlite3.Connection = Depends(_db)):
